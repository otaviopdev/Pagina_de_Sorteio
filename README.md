...
![Screenshot](./assets/images/pagina_de_sorteio.gif)
...
A Página de Sorteio foi desenvolvida com HTML5, CSS3 e JavaScript, cujo objetivo é demonstrar o meu aprendizado com o objeto Math.

## 🏁 Instalação:

Antes de começar, é bom ter um editor para trabalhar com o código, como: [VSCode](https://code.visualstudio.com/). Clone este repositório usando git clone: https://github.com/otaviopdev/Pagina_de_Sorteio.git ou clique em Code/Download ZIP. Clique no arquivo "index.html" e veja a aplicação.
...
Este projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/otaviopdev/Pagina_de_Sorteio/blob/main/LICENSE) para mais detalhes.
